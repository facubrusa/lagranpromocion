...
export const GoldenClover = ({ data }) => {
  useEffect(() => {
    AOS.init({
      duration: 1200,
      once: true,
    ...
    <>
      <section>
        ...
        <div data-aos="fade-up">
          <h1 className='text-5xl font-extrabold text-white text-center'>¿QUÉ ES EL GOLDEN?</h1>
          <h3 className='mt-7 text-2xl text-white text-center'>Es una nueva forma de ganar con La Gran Promoción.<br></br>
        ...
        <div data-aos="fade-up" className="text-center mt-12 font-bold text-2xl uppercase flex flex-col md:flex-row justify-center items-center p-4 gap-6 sm:px-4">
          ...
          >
            <FaTrophy className="h-6 w-6" /> Ganadores
          </a>
        </div>
